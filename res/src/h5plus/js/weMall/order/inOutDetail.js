...
seajs.use(['Ajax','dot','tips2','migrate','bootstrap','jqui','Dialog','uniform','bootstrap_fileupload','photon_select2','zclip','mousewheel','mCustomScrollbar','tagsinput'],
    ...
    var setModel = function() {
        ...
        var loginUrl = $$r.routers.data.link.loginUrl,
            uploadImgUrl = $$r.routers.data.link.uploadImgUrl,
            brandListUrl = $$r.routers.data.link.brandListUrl,
            brandAddUrl = $$r.routers.data.link.brandAddUrl,
            getBrandInfoUrl = $$r.routers.data.link.getBrandInfoUrl,
            editBrandUrl = $$r.routers.data.link.editBrandUrl,
            deleteBrandUrl = $$r.routers.data.link.deleteBrandUrl,
            goodsListUrl = $$r.routers.data.link.goodsListUrl,
            deleteGoodsUrl = $$r.routers.data.link.deleteGoodsUrl,
            goodsClassUrl = $$r.routers.data.link.goodsClassUrl,
            getGoodsDetaiSetlUrl = $$r.routers.data.link.getGoodsDetaiSetlUrl,
            attrListUrl = $$r.routers.data.link.attrListUrl,
            svaeSigleValVidUrl = $$r.routers.data.link.svaeSigleValVidUrl,
            svaeSigleValImageUrl = $$r.routers.data.link.svaeSigleValImageUrl,
            goodsAddUrl = $$r.routers.data.link.goodsAddUrl,
            goodsEditUrl = $$r.routers.data.link.goodsEditUrl;
            ...
            inOutDetailRequest:function(){
               var option = {
                    ...
                    success: function(json) {
                        $('#j_p').append($('#j_view_left').html());
                        $('#j_p').append($('#j_view_right').html());
                        console.log(json);
                    }
                }
                new Ajax(option); 
