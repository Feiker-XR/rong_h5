define(function(require, exports, module) {
    ...
    var Ajax = function(opt) {
        ...
        var deferred =opt.deferred || function() {};
        var when =opt.when || function() {};
        var then =opt.then || function() {};
        var done =opt.done || function() {};
        var fail =opt.fail || function() {};
        var resolve =opt.resolve || function() {};
        var reject =opt.reject || function() {};
        var always =opt.always || function() {};
        var promise =opt.promise || function() {};
