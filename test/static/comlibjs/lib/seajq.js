    ...
    m.param = function(a, b) {
        ...
        serializeArray: function() {
            return this.map(function() {
                ...
                var a = this.type;
                // console.log()
                return (!m(this).data('disabled')) && !(m(this).val() == '') &&this.name && !m(this).is(":disabled") && Uc.test(this.nodeName) && !Tc.test(a) && (this.checked || !W.test(a))
            }).map(function(a, b) {
                var c = m(this).val();

                if(m(this).data('value')){
                    c = m(this).data('value');
                    if(typeof(c)=='number'){
                        c = c.toString();
                    }
